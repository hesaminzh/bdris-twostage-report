...
The result of the simulations is shown below:

\begin{figure}[!h]
    \centering
    \includegraphics[width=0.42\textwidth]{two_stage.eps}
    % \vspace{-0.25cm}
    \caption{Comparison of sum-rate across fully-connected ``FC'', group-connected ``GC'' BD-RIS architectures when the direct link is present versus when it is not.}
\label{fig:two-stage}
\end{figure}
