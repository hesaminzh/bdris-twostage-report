function [P,Rate]=FP_algorithm_with_noise(H,transmit_SNR,tolerance,sigma2)
% github: https://github.com/YijieLinaMao/BD-RIS-low-complexity
    % INPUTS:
        %H: equivalent channel --- Ntxk
        %transmit_SNR: transmit_SNR at the BS
        %tolerance: accuracy of convergence 
    % OUTPUTS:
        %P: beamformer matrix
        %Rate: sum-rate of the users

[Nt,K]=size(H);
noise=ones(K,1).*sigma2;
